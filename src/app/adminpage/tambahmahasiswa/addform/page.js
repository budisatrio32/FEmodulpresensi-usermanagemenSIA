...
export default function AddMahasiswaForm() {
    ...
    return (
    <div className="min-h-screen bg-brand-light-sage">
        <AdminNavbar title="Dashboard Admin - Tambah Mahasiswa" />
        ...
        <div className="mb-10">
            ...
            <div>
                ...
                style={{ fontFamily: 'Urbanist, sans-serif' }}
                >
                Isi form di bawah ini untuk menambahkan mahasiswa baru ke sistem
                </p>
            </div>
            </div>
        </div>
        ...
        >
            ...
            <Field>
                ...
                <div className="flex-1">
                    ...
                    Centang jika akun mahasiswa ini aktif
                    </FieldDescription>
                </div>
                </div>
            </Field>
